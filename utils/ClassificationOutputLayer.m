...
function classWeights = getClassWeights(weightScale, imbalance)
  arguments
        weightScale=1
        imbalance=1000-weightScale
   end
  classWeights = [weightScale / (weightScale + imbalance), ...
                  imbalance / (weightScale + imbalance)];
end
...
if isempty (inputArguments.ClassWeights)
    inputArguments.ClassWeights=getClassWeights;
end
end